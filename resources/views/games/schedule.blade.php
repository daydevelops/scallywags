...
@section('content')
	<header>
		...
		<form class="form-inline">
			...
			<label class="my-1 mr-2" for="filter-player">Player: </label>
			<select class="custom-select my-1 mr-sm-2" id="filter-player">
			...
			<label class="my-1 mr-2" for="filter-gt">Game Type: </label>
			<select class="custom-select my-1 mr-sm-2" id="filter-gt">
